...
__release__, __svn_revision__ = pkg_resources.resource_string(__name__, "VERSION").strip().split(b'-')
__major_version__, __minor_version__, __release_version__ = list(map(int, __release__.split(b'.')))
